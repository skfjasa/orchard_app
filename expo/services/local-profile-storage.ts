...
export const EXTRA_SLOTS_KEY = "duet.extraSlots.v1";
export const BOOST_KEY = "duet.boostedUntil.v1";
export const SUPERLIKE_BALANCE_KEY = "duet.superLikeBalance.v1";
export const SUPERLIKE_LAST_USE_KEY = "duet.superLikeLastUse.v1";
export const SUBSCRIPTION_KEY = "duet.subscription.v1";
