...
const BASE_PROFILES: Profile[] = [
  ...
  },
  {
    ...
    lookingFor: "Together",
    polyType: "Throuple",
    bio: "Married 4 years, searching for a third who loves late dinners and Sunday records.",
  ...
  },
  {
    ...
    lookingFor: "Together",
    polyType: "Polycule",
    bio: "Queer, kinky, kind. We host monthly dinners and host even better conversations.",
  ...
  },
  {
    ...
    lookingFor: "Solo",
    polyType: "Solo poly",
    bio: "Theater director. Solo poly for a decade. I like directness and unhurried kisses.",
  ...
  },
  {
    ...
    lookingFor: "Together",
    polyType: "Swinger",
    bio: "Married 10 years, playful 4. Weekend house in the Catskills. Come for the wine, stay for the conversation.",
