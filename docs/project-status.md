...
2. Continue provider-internal cleanup after Slice 6/Slice 5b: move the next small state domain, likely backend match/thread hydration application or local block/report cleanup, out of `ProfileProvider` behind clearer services without changing visible UI.
