...
1. Smoke-UAT badge stability and Fruit filtering: matched real/dev profiles should not appear in Fruit, cleared Inbox badges should not flash back during rapid back from Chat, and cleared badges should not reappear after 10+ seconds unless new activity arrives.
