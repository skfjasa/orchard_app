...
2. Continue provider-internal cleanup after Slice 6/Slice 5b: isolate remaining profile lifecycle application paths, especially profile update/sign-out cleanup, without changing visible UI.
