...
- Fixture content audit on 2026-07-08 confirmed seeded/local demo rows use deterministic fixture emails/ids and fictional mock copy. Mildly suggestive wording in local mock profiles and `supabase/seed.sql` was neutralized so fixtures remain suitable for inner-circle demos without explicit sexual content.
