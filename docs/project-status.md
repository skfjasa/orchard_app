...
2. Continue provider-internal cleanup after Slice 6/Slice 5b: move profile bootstrap application out of `ProfileProvider` behind clearer services without changing visible UI.
