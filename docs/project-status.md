...
2. Continue provider-internal cleanup after Slice 6/Slice 5b: isolate remaining lifecycle cleanup paths, especially sign-out/reset orchestration, without changing visible UI.
