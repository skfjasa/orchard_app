...
2. Continue provider-internal cleanup after Slice 6/Slice 5b: move the next small state domain, likely fixture match repair paths or backend match/thread hydration application, out of `ProfileProvider` behind clearer services without changing visible UI.
