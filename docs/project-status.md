...
2. Continue provider-internal cleanup after Slice 6/Slice 5b: isolate remaining backend-first action and residual provider facade state paths without changing visible UI.
