...
values
  ...
  ('10000000-0000-4000-8000-000000000009', 'Ines & Miles', '1995-01-01', true, 'Harlem, NY', 40.8116, -73.9465, 'Woman', array['Throuple'], 'couple', 'Together', array['Women','Non-binary','Couples'], '{}', 'Married 4 years, looking for a shared connection built on late dinners and Sunday records.', true, true, true, now()),
  ...
  ('10000000-0000-4000-8000-000000000012', 'Sage & River', '1999-01-01', true, 'Bushwick, NY', 40.6958, -73.9171, 'Non-binary', array['Polycule'], 'couple', 'Together', array['Everyone'], '{}', 'Queer, creative, kind. We host monthly dinners and host even better conversations.', true, true, true, now()),
  ...
  ('10000000-0000-4000-8000-000000000014', 'Nadia', '1991-01-01', true, 'Long Island City, NY', 40.7447, -73.9485, 'Woman', array['Solo poly'], 'single', 'Solo', array['Everyone'], '{}', 'Theater director. Solo poly for a decade. I like directness and unhurried chemistry.', true, true, true, now()),
  ...
  ('10000000-0000-4000-8000-000000000021', 'Margot & Felix', '1990-01-01', true, 'Tribeca, NY', 40.7163, -74.0086, 'Woman', array['Swinger'], 'couple', 'Together', array['Women','Couples'], '{}', 'Married 10 years, open 4. Weekend house in the Catskills. Come for the wine, stay for the conversation.', true, true, true, now()),
